/**
 * TasteExploration Component - Standalone Version
 *
 * Adapted from src/components/TasteExploration/TasteExploration.jsx
 * Changes:
 * - Import path for tasteQuads uses @shared alias
 * - Added initialSelections, initialSkipped, initialIndex props for session restore
 * - Added onProgress callback for auto-save
 */
...
import { quads, categories, categoryOrder, getTotalQuadCount } from '@shared/tasteQuads';
...
// ============================================================
const TasteExploration = ({
  clientName,
  respondentType,
  onComplete,
  onBack,
  onProgress,           // NEW: Callback for auto-save
  initialSelections,    // NEW: Restore from saved session
  initialSkipped,       // NEW: Restore from saved session
  initialIndex          // NEW: Restore from saved session
}) => {
  ...
  // Initialize state from props (for session restore)
  ...
  // Call onProgress when selections, skipped, or currentIndex change
  useEffect(() => {
  ...
  }, [selections, skipped, currentIndex, onProgress, isComplete]);
