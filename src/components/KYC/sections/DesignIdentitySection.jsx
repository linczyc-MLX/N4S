...
const CLOUDINARY_BASE = 'https://res.cloudinary.com/drhp5e0kl/image/upload/Taste-Exploration/Arch-Style';
const PROFILE_STORAGE_PREFIX = 'n4s_taste_profile_';

// Architectural Styles Data
const ARCH_STYLES = [
  { id: 'AS1', name: 'Avant-Contemporary', image: `${CLOUDINARY_BASE}/AS1`,
  ...
  { id: 'AS2', name: 'Architectural Modern', image: `${CLOUDINARY_BASE}/AS2`,
  ...
  { id: 'AS3', name: 'Curated Minimalism', image: `${CLOUDINARY_BASE}/AS3`,
  ...
  { id: 'AS4', name: 'Nordic Contemporary', image: `${CLOUDINARY_BASE}/AS4`,
  ...
  { id: 'AS5', name: 'Mid-Century Refined', image: `${CLOUDINARY_BASE}/AS5`,
  ...
  { id: 'AS6', name: 'Modern Classic', image: `${CLOUDINARY_BASE}/AS6`,
  ...
  { id: 'AS7', name: 'Classical Contemporary', image: `${CLOUDINARY_BASE}/AS7`,
  ...
  { id: 'AS8', name: 'Formal Classical', image: `${CLOUDINARY_BASE}/AS8`,
  ...
  { id: 'AS9', name: 'Heritage Estate', image: `${CLOUDINARY_BASE}/AS9`,
  ...
  <div className="arch-style-card">
    ...
    <div className="arch-style-card__content">
      ...
      <ul className="arch-style-card__features">
        {style.features.map((f, i) => <li key={i}>{f}</li>)}
      </ul>
